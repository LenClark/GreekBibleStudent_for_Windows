...
namespace GreekBibleStudent
{
    internal class classSearch
    {
        ...
        private void displayToolStripMessage(StatusStrip searchStrip, int toolStripIndex, String message)
        {
            ...
            //            toolStriplabel = globalVars.getStatusMessage(toolStripIndex);
        ...
        */
        ...
        private void controlSearch()
        {
            ...
            globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                globalVars.StatStrip, 0, "Performing your search");
                                 ...
                                 NumericUpDown searchSpan, bool exclude_include)
        {
            ...
            if (isWorthProgressing)
            {
                ...
                globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                    globalVars.StatStrip, 0, "Scanning the OT for uses of " + pWord);
            ...
            globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                globalVars.StatStrip, 0, "Single word search complete");
            displayLXXResults();
        }
                                                          ...
                                                          int sBook, String sChap, String sVerse, int sSeq, String sWord)
        {
            ...
            globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                globalVars.StatStrip, 0, "Analysing the given primary word");
            ...
            if (pBook >= 0)
            {
                ...
                globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                    globalVars.StatStrip, 0, pWord + " found; checking validity");
                ...
                verifyResult = verifyWord(pBook, pChap, pVerse, pSeq, primaryString, matchType);
                isWordGiven = verifyResult.IsWordGiven;
                if (isWordGiven) primaryString = verifyResult.RootWord;
            }
            ...
            if (isWordGiven)
            {
                ...
                {
                    globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                        globalVars.StatStrip, 0, "Analysing the given secondary word");
                    if (sBook >= 0)
                    {
                        // Okay, we have a word.  But does it match?
                        ...
                        globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                            globalVars.StatStrip, 0, sWord + " found; checking validity");
                        verifyResult = verifyWord(sBook, sChap, sVerse, sSeq, secondaryString, matchType);
                        isSWordGiven = verifyResult.IsWordGiven;
                        if (isWordGiven) secondaryString = verifyResult.RootWord;
                    }
                }
            }
        ...
        private void primaryScan(String targetWord, int matchType)
        {
            ...
            for (bdx = 0; bdx < noOfBooks; bdx++)
            {
                ...
                globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                    globalVars.StatStrip, 0, "Simple scan in process; scanning " + currentBook.BookName);
        ...
        private void secondaryScan(String pWord, String sWord, NumericUpDown searchSpan)
        {
            ...
            for (idx = 0; idx < noOfMatches; idx++)
            {
                ...
                globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                    globalVars.StatStrip, 0, "Now looking for secondary matches; scanning " + referenceString);
        ...
        {
            globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                globalVars.StatStrip, 0, "Starting display of results");
        ...
        private void displayPrimary()
        {
            ...
            for (idx = 0; idx < noOfMatches; idx++)
            {
                ...
                globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                    globalVars.StatStrip, 0, "Displaying: " + workingText);
                formattedDisplay(resultsTextView, globalVars.getTextSize(4, 1), globalVars.getDefinedFontNameByIndex(4, 1),
            ...
            globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                globalVars.StatStrip, 0, "Search Results complete");
        }
...
//            String[] unorderedKeys, orderedKeys;
            ...
            foreach ( KeyValuePair<String, classSearchVerse> matchedPair in versesMatched)
            {
                ...
                globalVars.StatStrip.Invoke(new performToolStripMessage(displayToolStripMessage),
                    globalVars.StatStrip, 0, "Displaying: " + referenceText);
                formattedDisplay(resultsTextView, globalVars.getTextSize(4, 1), globalVars.getDefinedFontNameByIndex(4, 1),
